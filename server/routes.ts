...
- Для выручки ищи конкретные цифры: "выручка", "доходы", "оборот", "прибыль", финансовые показатели в млрд/млн рублей или долларов
- Для сотрудников ищи точные числа: "сотрудников", "работников", "персонал", "штат"
- Для отрасли используй точные названия: "Информационные технологии", "Банковские услуги", "Промышленность" и т.д.
- Для продуктов перечисли основные направления деятельности
- Внимательно читай финансовые данные и извлекай актуальные показатели`;
